...
public class Word2VEC {
	...
	public static void main(String[] args) throws IOException {
		...
		vec.loadModel("models//en-es_embedding_vulicmoens.bin");
		...
		for(int i = 0; i < vec.wordList.length; i++)
		{
			String word = vec.wordList[i];
			System.out.println(word + "\t" + Arrays.toString(vec.getWordVector(word)));
		}
