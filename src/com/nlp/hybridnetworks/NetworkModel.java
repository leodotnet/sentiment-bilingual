...
import static com.nlp.commons.Utils.print;
...
import com.nlp.hybridnetworks.NetworkConfig.ModelType;
...
//			System.err.println(k);
		...
		/***debug**/
		//for (int fstr = 0; fstr < this._fm.getParam_G().getWeights().length; fstr++)
			//System.err.println(fstr + " : " + Arrays.toString(this._fm.getParam_G().getFeatureRep(fstr)));
		/*****/
